...
const Fitur = () => {
    return (
        <section id='fitur' className='grid grid-cols-10 w-full text-greenDark mt-32 bg-white px-20 max-lg:px-10 max-md:px-5 max-sm:px-1'>
            <div className='col-span-7 p-20 max-lg:px-10 max-md:px-5 max-sm:px-2'>
            ...
            <div className='col-span-3 flex bg-green p-16 max-lg:p-10 max-md:p-5 rounded-b-2xl'>
                <motion.div
            ...
            <div className='col-span-3 flex bg-green p-16 max-lg:p-10 max-md:p-5 rounded-2xl'>
                <motion.div
                    initial={{ x: 20, opacity: 0 }}
                    whileInView={{ x: 0, opacity: 1, transition: { delay: 0.2 } }}
                >
            ...
            <div className='col-span-3 flex bg-green p-16 max-lg:p-10 max-md:p-5 rounded-t-2xl'>
                <motion.div
                    initial={{ x: 20, opacity: 0 }}
                    whileInView={{ x: 0, opacity: 1, transition: { delay: 0.2 } }}
                >
